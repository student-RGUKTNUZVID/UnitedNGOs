    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div class="text-center mt-8">
          <a href="/success-stories" data-discover="true">
            <button class="font-poppins font-medium px-8 bg-green-800 text-white text-[20px] text-center rounded-[30px] w-[200px] h-[60px] shadow-md hover:bg-green-600 transition">
              View All
            </button>
          </a>
        </div>
